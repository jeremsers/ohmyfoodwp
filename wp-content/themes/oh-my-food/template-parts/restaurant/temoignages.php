<section class="temoignages">
    ...
    <div class="temoignages-container">
        ...
        <div class="temoignages-card">
            ...
            <p class="temoignages-card-author">Éléonore Dubois, Fondatrice d'Ohmyfood</p>

            <img class="temoignages-card-image" src="http://ohmyfood.local/wp-content/uploads/2025/06/dubois.jpeg"
                alt="Témoignage 1" height="100" width="100">
        ...
        <div class="temoignages-card">
            ...
            <p class="temoignages-card-author">Marion L.</p>
            <div class="temoignages-card-placeholder">
                <p class="temoignages-card-placeholder-text">ML</p>
            </div>
